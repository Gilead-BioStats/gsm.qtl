test_that("discontinuation_groupBar uses all arguments (#80)", {
...
test_that("discontinuation_reasonBar uses df and reason variable (#80)", {
  df <- qtl_test_participant_df()
...
test_that("reasons_groupBar uses group and reason arguments (#80)", {
  df <- qtl_test_participant_df()
...
test_that("discontinuation_map_reasons respects yaml_path (#80)", {
  df <- qtl_test_participant_df()
