...
- [`Analyze_OneSideProp()`](https://gilead-biostats.github.io/gsm.qtl/reference/Analyze_OneSideProp.md)
  **\[stable\]** : Funnel Plot Analysis with Normal Approximation for
  Binary and Rate Outcomes.
- [`Eligibility_Overview()`](https://gilead-biostats.github.io/gsm.qtl/reference/Eligibility_Overview.md)
  : Eligibility Overview Table
- [`QTL_Overview()`](https://gilead-biostats.github.io/gsm.qtl/reference/QTL_Overview.md)
  : QTL Overview Table
...
- [`ResultsProcessor()`](https://gilead-biostats.github.io/gsm.qtl/reference/ResultsProcessor.md)
  : Title
- [`calc_fig_size()`](https://gilead-biostats.github.io/gsm.qtl/reference/calc_fig_size.md)
...
- [`discontinuation_map_reasons()`](https://gilead-biostats.github.io/gsm.qtl/reference/discontinuation_map_reasons.md)
  : Filter Discontinuation Reasons in data.frame
- [`discontinuation_reasonBar()`](https://gilead-biostats.github.io/gsm.qtl/reference/discontinuation_reasonBar.md)
...
- [`eligibility_sourceBar()`](https://gilead-biostats.github.io/gsm.qtl/reference/eligibility_sourceBar.md)
...
- [`scrollable_gt()`](https://gilead-biostats.github.io/gsm.qtl/reference/scrollable_gt.md)
