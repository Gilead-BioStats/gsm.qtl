...
discontinuation_groupBar(
  ...
  strGroupLabel = "Site", 
  varStatus = compreas, 
  valuesDiscontinued = c('WITHDRAWAL BY SUBJECT', 'NON-COMPLIANCE WITH STUDY DRUG', 'PROTOCOL VIOLATION', 'PHYSICIAN DECISION', 'Withdrew Consent', 'Death', 'Lost to Follow-Up')
)
```
