...
site_bar <- dfListing %>% 
  ...
  ggplot(., aes(y = forcats::fct_rev(forcats::fct_infreq(invid)), fill = fillcol,
                text = paste0("Site: ",forcats::fct_rev(forcats::fct_infreq(invid)), 
  ...
  scale_fill_manual(values = c("Ineligible" = "#FF5859",
                               ...
                               "Neither" = "#7CAE00")) +
  theme_classic() 
plotly::ggplotly(site_bar, tooltip = c("x", "text")) %>%
...
country_bar <- dfListing %>% 
  ...
  ggplot(., aes(y = forcats::fct_rev(forcats::fct_infreq(country)), fill = fillcol,
                text = paste0("Country: ",forcats::fct_rev(forcats::fct_infreq(country)), 
                             "\nEligibility Status: ", fillcol))) +
  geom_bar() +
  ...
  scale_fill_manual(values = c("Ineligible" = "#FF5859",
                               ...
                               "Neither" = "#7CAE00")) +
  theme_classic() 
plotly::ggplotly(country_bar, tooltip = c("x", "text")) %>%
  layout(margin = list(l = 50, r = 50, b = 150, t = 50),
