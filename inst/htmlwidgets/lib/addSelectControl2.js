 ...
 */
const addSelectControl2 = function(widgetControls, label, values, addNone = true, defaultValue = 'None') {
    ...
    for (const value of values) {
      ...
      option.value = value;
      option.text  = value;
      // if this is the one we want by default, mark it selected
  ...
  // remove the old `select.value = defaultValue;`
  return select;
}
